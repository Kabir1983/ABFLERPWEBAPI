...
using ABFLBlazorApp.Blazor.Server.Services;
...
namespace ABFLBlazorApp.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<ABFLBlazorAppBlazorApplication>();
            builder.Modules
                .AddAuditTrailEFCore()
                ...
                .Add<ABFLBlazorApp.Module.ABFLBlazorAppModule>()
            	.Add<ABFLBlazorAppBlazorModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithAuditedDbContext(contexts => {
                        contexts.Configure<ABFLBlazorApp.Module.BusinessObjects.ABFLBlazorAppEFCoreDbContext, ABFLBlazorApp.Module.BusinessObjects.ABFLBlazorAppAuditingDbContext>(
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(ABFLBlazorApp.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(ABFLBlazorApp.Module.BusinessObjects.ApplicationUserLoginInfo);
