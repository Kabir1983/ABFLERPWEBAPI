...
namespace ABFLBlazorApp.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class ABFLBlazorAppModule : ModuleBase {
    public ABFLBlazorAppModule() {
		// 
		// ABFLBlazorAppModule
		// 
		AdditionalExportedTypes.Add(typeof(ABFLBlazorApp.Module.BusinessObjects.ApplicationUser));
